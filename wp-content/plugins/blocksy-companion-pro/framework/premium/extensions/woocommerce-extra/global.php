...
blocksy_output_responsive([
	...
	'value' => [
		'desktop' => $position['desktop'] === 'top' ? 'CT_CSS_SKIP_RULE' : 'var(--false)',
		'tablet' => $position['tablet'] === 'top' ? 'CT_CSS_SKIP_RULE' : 'var(--false)',
		'mobile' => $position['mobile'] === 'top' ? 'CT_CSS_SKIP_RULE' : 'var(--false)'
	],
	'unit' => '',
]);
